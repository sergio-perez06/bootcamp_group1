...
import com.mercadolibre.fernandez_federico.Application;
...
public class BillControllerTest extends IntegrationTest{
    @Autowired
    ...
    private List<Bill> createListBill() throws JsonProcessingException {
        ...
        String bill = "[\n" +
                ...
                "    }\n" +
                "]";
        //return objectMapper.readValue(bill,Bill.class);
